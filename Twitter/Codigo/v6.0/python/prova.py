...
def main():
	...
	try:
		...
		if(NOMBRE_ARCHIVO_ENTRADA == ""):
			NOMBRE_ARCHIVO_ENTRADA = "../input/data.csv"
	except:
		NOMBRE_ARCHIVO_ENTRADA = "../input/data.csv"
	...
	try:	
		...
		if(NOMBRE_ARCHIVO_SALIDA1 == ""):
			NOMBRE_ARCHIVO_SALIDA1 = "../output/pe_twt_down_publicacion_fecha_hora.txt"
	except:
		NOMBRE_ARCHIVO_SALIDA1 = "../output/pe_twt_down_publicacion_fecha_hora.txt"
	...
	try:
		...
		if(NOMBRE_ARCHIVO_SALIDA2 == ""):
			NOMBRE_ARCHIVO_SALIDA2 = "../output/pe_twt_down_opinion_fecha_hora.txt"
	except:
		NOMBRE_ARCHIVO_SALIDA2 = "../output/pe_twt_down_opinion_fecha_hora.txt"
	...
	f_nuevo			= open('../output/data.csv',	'wb')
	...
	for item in lines:
		linea 	= item.strip().split(';')

		usuarios.append	(linea[0])
		tags.append		(linea[1].split(','))
		sinces.append	(linea[2])

		l_data.append(linea[0:2] + [0])
	...
	for inusuario in usuarios:
		...
		f_nuevo.write(str(next_begin) + '\n')

		print "!@#END"
		print next_begin

		l_data[c][2]	= str(next_begin)
		c = c + 1
