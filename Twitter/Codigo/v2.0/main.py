...
class EntitiesPersonalizado(object):
	...
	def __init__(self,entidades,entidades_extendidos = {}):
		...
		if entidades_extendidos.has_key('media'):
			for media_es in entidades_extendidos['media']:
...
class StatusPersonalizado(object):
	...
	def __init__(self,posteo):
		...
		if hasattr(posteo, "extended_entities"):
			self.entities = EntitiesPersonalizado(posteo.entities, posteo.extended_entities)
		else:
...
def main():
	...
	try:	
		...
		if(NOMBRE_ARCHIVO_SALIDA == ""):
			NOMBRE_ARCHIVO_SALIDA = "postsTwitter.csv"
				
	except:
		NOMBRE_ARCHIVO_SALIDA = "postsTwitter.js"
