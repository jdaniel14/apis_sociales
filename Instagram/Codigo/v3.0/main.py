...
def main():
	...
	try:	
		...
		if(NOMBRE_ARCHIVO_SALIDA1 == ""):
			NOMBRE_ARCHIVO_SALIDA1 = "pe_ins_down_publicacion_fecha_hora.txt"
	...
	try:	
		...
		if(NOMBRE_ARCHIVO_SALIDA2 == ""):
			NOMBRE_ARCHIVO_SALIDA2 = "pe_ins_down_opinion_fecha_hora.txt"
	...
	for inusuario in usuarios:
		...
		while (True):
			...
			for item in posts:
				...
				escritorPublicacion.write(lista_jsons[j])
		...
		for intag in tagsuser:
			...
			while (True):
				...
				for item in posts:
					...
					escritorOpinion.write(lista_jsons[j])
