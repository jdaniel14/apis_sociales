...
def main():
	...
	#token online
	token = "CAACEdEose0cBAIgyydetZAKwc1hKsrL0JhHxF4CuupO7GqCZBKhd0Q4XwAa4LjZCA1JOoXQRQsdUFM0AeWia5GGWDxFu3X7ntQwgbOyRZB7ZBZBf1lOzoLJziZBkijhDa9ZCnIw0rzIEffNn6LfB8eOThAVGoWBOxJS2elacUypxx3mq52gLiCHzHej2aMZBqJupaQp4CbPCsdAlcXRTI870mmDP1fW1mVxsZD"
	...
	for item in lines:
		linea = item.split(';')
		sinces.append(linea[0])
		usuarios.append(linea[1])
		tags.append(linea[2].split(','))
