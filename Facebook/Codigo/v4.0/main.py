...
def get_facebook_bed():

	oauth_args = dict(	client_id     = '894779450563269',
						client_secret = '7a235aefb76bf6322e5864c2a70ff3d8',
...
def main():
	...
	graph = get_facebook_bed()#facebook.GraphAPI(token)
